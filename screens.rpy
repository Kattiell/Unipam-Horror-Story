...
#            textbutton _("Auto") action Preference("auto-forward", "toggle")
            ...
            textbutton _("Salvamento Automático") action QuickSave()
...
#            textbutton _("History") action ShowMenu("history")
        ...
        textbutton _("Salvos") action ShowMenu("load")
...
style main_menu_version:
    properties gui.text_properties("versão")
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            label "[config.name!t]"
            text _("Versão 1.0 [config.version!t]\n")

            ## gui.about is usually set in options.rpy.
            if gui.about:
                text "[gui.about!t]\n"

            text _("Criado junto do sistema: {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")


## This is redefined in options.rpy to add text to the about screen.
define gui.about = "Unipam"
    ...
    use game_menu(_("Configurações"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Opções de Pular")
                    textbutton _("Texto não visto") action Preference("skip", "toggle")
                    textbutton _("Após Escolher") action Preference("after choices", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Velocidade do modo Automático")
...
screen keyboard_help():
    ...
    hbox:
        label "V"
        text _("Alterna assistiva {a=https://www.renpy.org/l/voicing} voz própria{/a}.")
